...
import { Upload, Camera, DollarSign, Package, User, Mail, Phone, Calendar } from 'lucide-react-native';
...
export default function PromoteProduct() {
  ...
  const handleContinueToPayment = () => {
    ...
    const selectedDuration = promotionDurations.find(d => d.value === productData.duration);
    ...
    <>
      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.welcomeSection}>
          <Text style={styles.welcomeTitle}>Welcome to Smart Shopping Vendor Portal</Text>
          <Text style={styles.welcomeDescription}>
            Promote your products to thousands of Smart Shopping app users. 
            Reach new customers and boost your sales with our intelligent product discovery platform.
          </Text>
        </View>
          ...
          <View style={styles.pricingCards}>
            {promotionDurations.map((duration) => (
              <TouchableOpacity
                ...
                style={[
                  styles.pricingCard,
                  productData.duration === duration.value && styles.selectedPricingCard
                ]}
                onPress={() => updateField('duration', duration.value)}
              >
                <Text style={styles.pricingDuration}>{duration.value} Days</Text>
          ...
          <View style={styles.inputGroup}>
            ...
            <TouchableOpacity style={styles.imageUpload} onPress={showImageOptions}>
              {productData.imageUri ? (
                <Image source={{ uri: productData.imageUri }} style={styles.uploadedImage} />
              ) : (
        ...
        <View style={styles.summarySection}>
          ...
          <View style={styles.summaryCard}>
            <View style={styles.summaryRow}>
              ...
              <Text style={styles.summaryValue}>{productData.duration} days</Text>
            </View>
            <View style={styles.summaryRow}>
              <Text style={styles.summaryLabel}>Promotion Fee:</Text>
              <Text style={styles.summaryValue}>${selectedDuration?.price}</Text>
            </View>
            <View style={styles.summaryRow}>
